...
import com.naver.myhome4.mybatis.mapper.BoardMapper; //�ٿ��� �������� Mapper�� ä����
...
public class BoardServiceImpl implements BoardService{
	...
	@Autowired
	public BoardServiceImpl(BoardMapper dao) {	//�ٿ��� �����Ͽ� ���
		this.dao = dao;
	}

	@Override
	public int getListCount() {
		return dao.getListCount(); //�ٿ� ȣ���ؼ� ����Ʈ ��� �˷���. ������ ������ ������ �ٷ� ����.
	}
	...
	@Override
	public boolean isBoardWriter(int num, String pass) { //�ΰ� ���� �ٸ��ٺ��� Object�� ���� �� �ְ���
