  		  ...
  		  <td> <%-- 제목 --%>
  		  	<div>
  		  		<%-- 답변글 제목앞에 여백 처리 부분
  		  		 ...
  		  		 --%>
  		  		 <c:if test="${b.BOARD_RE_LEV != 0 }">  <%-- 답글인 경우 이미지 삽입.--%>
  		  		 	<c:forEach var="a" begin="0" end="${b.BOARD_RE_LEV*2 }" step="1">  <!-- 공백으로 단 나눔 -->
  		  		 	&nbsp;
  		  		 	</c:forEach>
  		  		 ...
  		  		 <a href="detail?num=${b.BOARD_NUM }">    <%--detail?num=$~ 여기 띄어쓰기 하면 안됨 --%>
